...
$evento = '<div id="pannello-principale-pe">
                ...
                <div class="containerPrincipale-pe">
                    <div class="container_sx-pe">
                        <h2>' . $row['titolo'] . '</h2>
                        <p class="dataEvento-pe"><time datetime="' . $row['data_inizio'] . '">' . date("d", strtotime($row['data_inizio'])) . date("F Y", strtotime($row['data_inizio'])) . ' alle ore ' . date("H:i", strtotime($row['orario_inizio'])) . '</time></p>
                        <p>' . $row['luogo'] . '</p>
                    </div>
                ...
                <div class="containerSecondario-pe">
                    ...
                    <div class="accountEvento-pe">
                        <img src="../Images/UCI.png" alt="Account">
